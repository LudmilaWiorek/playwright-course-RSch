...
export class PaymentPage {
    ...
    activateDiscount = async () => {
        ...
        // OPTION 2 for laggy inputs: using slowly typing 
        // await this.discountInput.focus()
        // await this.page.keyboard.type(code, {delay: 1000}) //delay - dodaje przerwę o danej długości między kazdym przyciskiem klawiatury
        // expect(await this.discountInput.inputValue()).toBe(code)

        expect(await this.discountedValue.isVisible()).toBe(false)//boolean => false or true
