...
import { v4 as uuidv4 } from 'uuid'; //ze strony: https://www.npmjs.com/package/uuid
...
test("New user full end-to-end journey", async ({ page }) => {
    ...
    await paymentPage.fillPaymentDetails(paymentDetails) //nowa metoda fillPaymentDetails i nowy object - payment Details
